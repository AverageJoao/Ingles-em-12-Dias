...
const DATABASE = {
    grammar: [
        ...
        { q: "To Burn (Simple Past)", options: ["Burnt", "Burned", "Borne"], correct: "Burnt" }, // Note: Burned is also acceptable, but Burnt fits irregular pattern
        ...
        { q: "To Dream (Simple Past)", options: ["Dreamt", "Dreamed", "Droman"], correct: "Dreamt" },
        ...
        { q: "To Fit (Simple Past)", options: ["Fit", "Fitted", "Fat"], correct: "Fit" },
        ...
        { q: "To Hang (Simple Past)", options: ["Hung", "Hanged", "Hang"], correct: "Hung" },
        ...
        { q: "To Light (Simple Past)", options: ["Lit", "Lighted", "Lote"], correct: "Lit" },
        ...
        { q: "To Quit (Simple Past)", options: ["Quit", "Quitted", "Quitten"], correct: "Quit" },
        ...
        { q: "To Shine (Simple Past)", options: ["Shone", "Shined", "Shonen"], correct: "Shone" },
        { q: "To Shoot (Simple Past)", options: ["Shot", "Shooted", "Shooten"], correct: "Shot" },
        { q: "To Show (Simple Past)", options: ["Showed", "Shew", "Shown"], correct: "Showed" }, // Trick: Showed is correct past, Shown is participle
        ...
        { q: "To Smell (Simple Past)", options: ["Smelt", "Smelled", "Smollen"], correct: "Smelt" },
        { q: "To Sow (Simple Past)", options: ["Sowed", "Sew", "Sown"], correct: "Sowed" },
        { q: "To Spell (Simple Past)", options: ["Spelt", "Spelled", "Spol"], correct: "Spelt" },
        { q: "To Spend (Simple Past)", options: ["Spent", "Spended", "Spon"], correct: "Spent" },
        { q: "To Spill (Simple Past)", options: ["Spilt", "Spilled", "Spoll"], correct: "Spilt" },
        { q: "To Spin (Simple Past)", options: ["Span", "Spinned", "Spun"], correct: "Span" }, // Spun is also accepted, Span archaic but distinct
        ...
        { q: "To Spoil (Simple Past)", options: ["Spoilt", "Spoiled", "Spolen"], correct: "Spoilt" },
        ...
        { q: "To Sweat (Simple Past)", options: ["Sweat", "Sweated", "Swot"], correct: "Sweat" },
        //{ q: "To Sweep (Simple Past)", options: ["Swept", "Sweeped", "Swopen"], correct: "Swept" },
        //{ q: "To Swim (Simple Past)", options: ["Swam", "Swimmed", "Swum"], correct: "Swam" },
        //{ q: "To Swing (Simple Past)", options: ["Swung", "Swinged", "Swang"], correct: "Swung" },
        //{ q: "To Teach (Simple Past)", options: ["Taught", "Teached", "Tought"], correct: "Taught" },
        //{ q: "To Tear (Simple Past)", options: ["Tore", "Teared", "Torn"], correct: "Tore" },
        //{ q: "To Tell (Simple Past)", options: ["Told", "Telled", "Tolled"], correct: "Told" },
        //{ q: "To Think (Simple Past)", options: ["Thought", "Thinked", "Thank"], correct: "Thought" },
        //{ q: "To Throw (Simple Past)", options: ["Threw", "Throwed", "Thrown"], correct: "Threw" },
        //{ q: "To Understand (Simple Past)", options: ["Understood", "Understanded", "Understonden"], correct: "Understood" },
        //{ q: "To Upset (Simple Past)", options: ["Upset", "Upsetted", "Upsat"], correct: "Upset" },
        //{ q: "To Wake (Simple Past)", options: ["Woke", "Waked", "Woken"], correct: "Woke" },
        //{ q: "To Wear (Simple Past)", options: ["Wore", "Weared", "Worn"], correct: "Wore" },
       // { q: "To Weep (Simple Past)", options: ["Wept", "Weeped", "Wopen"], correct: "Wept" },
       // { q: "To Win (Simple Past)", options: ["Won", "Winned", "Wanen"], correct: "Won" },
       //{ q: "To Wind (Simple Past)", options: ["Wound", "Winded", "Wand"], correct: "Wound" },
       // { q: "To Withdraw (Simple Past)", options: ["Withdrew", "Withdrawed", "Withdrawn"], correct: "Withdrew" },
      // { q: "To Withstand (Simple Past)", options: ["Withstood", "Withstanded", "Withstonden"], correct: "Withstood" },
       // { q: "To Wring (Simple Past)", options: ["Wrung", "Wringed", "Wrang"], correct: "Wrung" }
...
// --- CONTROLE DE TEMPO (FUSO BRASÍLIA UTC-3) ---

// Retorna o objeto Date ajustado para Brasília (sem depender do PC do usuário)
const getBrasiliaTime = () => {
    const now = new Date();
    // Converte para UTC
    const utc = now.getTime() + (now.getTimezoneOffset() * 60000);
    // Converte para Brasília (UTC - 3 horas)
    return new Date(utc - (3600000 * 3));
};

// Retorna a "Data do Jogo".
// Se for antes de 12:00 em Brasília, considera como se fosse o dia anterior (pois o reset é 12h)
...
// Retorna String YYYY-MM-DD baseada na lógica de meio-dia
const getGameDateString = () => {
    const d = getGameDateObj();
    return d.toISOString().slice(0, 10);
};

// --- LÓGICA DE ROTAÇÃO SEM REPETIÇÃO ---

// Epoch Day baseado no Game Date (reset ao meio dia)
const getEpochDay = () => {
    const start = new Date("2025-01-01").getTime();
    const gameDate = getGameDateObj();
    gameDate.setHours(0, 0, 0, 0); // Normaliza para meia-noite do "dia do jogo"
    return Math.floor((gameDate.getTime() - start) / (1000 * 60 * 60 * 24));
};
...
const init = () => {
    ...
    const todayGameStr = getGameDateString(); // Usa a data baseada no meio-dia
    const streak = localStorage.getItem('streak') || 0;
    
    document.getElementById('streak-display').innerText = `🔥 ${streak} dias seguidos`;

    if (lastPlayed === todayGameStr) {
        switchScreen('locked');
        startCountdown();
    } else {
        switchScreen('start');
...
const renderScramble = (data) => {
    ...
    const rng = seededRandomGenerator(getEpochDay()); 
...
const finishDailyChallenge = () => {
    ...
    // Salva a data do jogo atual (baseada no meio dia)
    const todayGameStr = getGameDateString();
    localStorage.setItem('lastPlayedDate', todayGameStr);
    
    // Streak Logic (Usa a data do jogo)
    const lastStreakDate = localStorage.getItem('lastStreakDate');

    if (lastStreakDate !== todayGameStr) {
        let currentStreak = parseInt(localStorage.getItem('streak') || 0);
        localStorage.setItem('streak', currentStreak + 1);
        localStorage.setItem('lastStreakDate', todayGameStr);
    }
...
const startCountdown = () => {
    const updateTimer = () => {
        const brtNow = getBrasiliaTime(); // Hora atual em Brasília
        
        // Define o alvo: Próximo meio-dia em Brasília
        const target = new Date(brtNow);
        if (brtNow.getHours() >= 12) {
            // Se já passou do meio-dia, o alvo é amanhã
            target.setDate(target.getDate() + 1);
        }
        // Define alvo exato para 12:00:00
        target.setHours(12, 0, 0, 0);
        
        const diff = target - brtNow;
